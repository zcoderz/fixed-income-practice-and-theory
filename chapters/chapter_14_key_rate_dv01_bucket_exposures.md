...
$$
\sum_{k=1}^K \text{Shift}_k(t) = 1\text{ bp}\quad \text{for all }t.
$$
...
> **What to check:** Confirm contract spec, the mapping from curve buckets to listed contracts, and the unit scaling (per contract vs per \$1mm).
...
**Investigation:** The $3,000 residual is 23% of explained P&L—material relative to the explained move. Possible causes:
