...
3. (Compute) Given $P_d(0,1)=0.9500$ and a 3M projection pseudo-factor $P^{3M}(0,1)=0.9430$, compute the implied average OIS-3M spread $\eta$ (in bp) in the representation $P^{3M}(0,1)=P_d(0,1)e^{-\eta\cdot 1}$.
